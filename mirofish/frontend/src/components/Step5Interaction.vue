        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>Send survey questionnaire to the world</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Quick chat version of the report generation agent, capable of calling 4 specialized tools with full MiroFish memory</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with simulated environment state, combined with Global/Local Memory mechanisms to provide deep cross-temporal attribution analysis</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Graph-structure-based breadth-first traversal algorithm that reconstructs event propagation paths and captures the full topology of information flow</div>
                  </div>
                </div>
                ...
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interview agent that can conduct multi-turn conversations in parallel with simulated individuals to collect unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with the Report Agent to explore report content in depth' : 'Chat with a simulated individual to learn their views' }}
              </p>
            </div>
            <div 
...
const renderMarkdown = (content) => {
  ...
  // Clean up cases where <p><br> precedes block-level elements (caused by extra blank lines)
  ...
  // Fix numbering for non-consecutive ordered lists: when a single-item <ol> is separated by paragraph content, maintain incrementing numbers
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    // Convert object dictionary to array, prioritizing reddit platform replies
