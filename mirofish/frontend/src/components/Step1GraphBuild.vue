    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, documents are automatically chunked and passed to Zep to build a knowledge graph — extracting entities and relationships, and forming episodic memory with community summaries.
          </p>
