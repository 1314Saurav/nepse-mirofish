    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even from a single paragraph of text, <span class=”highlight-bold”>MiroFish</span> can automatically generate a parallel world of up to <span class=”highlight-orange”>millions of Agents</span> seeded from real-world data. Inject variables from a god's-eye view and discover the <span class=”highlight-code”>”local optimum”</span> within complex group interactions under dynamic environments.
            </p>
            <p class=”slogan-text”>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any entity in the simulated world & chat with the ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g. If Wuhan University issues an announcement revoking Xiao's disciplinary action, what public opinion trend would follow?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Start simulation - navigate immediately; API call is handled in the Process page
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Using Space Grotesk as the primary heading font, JetBrains Mono as the code/label font.
