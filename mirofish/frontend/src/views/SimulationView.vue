...
const handleNextStep = (params = {}) => {
  ...
  // Pass custom rounds via query parameter if provided
  if (params.maxRounds) {
 ...
 * When the user navigates back from Step 3 to Step 2, the simulation is exited by default.
 */
const checkAndStopRunningSimulation = async () => {
  ...
  try {
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      ...
      // Attempt a graceful shutdown of the simulation environment
      try {
