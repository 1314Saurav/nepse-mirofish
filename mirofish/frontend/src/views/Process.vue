            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After documents are uploaded, the LLM analyzes their content and automatically generates an ontology structure suitable for opinion simulation (entity types + relation types).
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Based on the generated ontology, documents are chunked and fed to the Zep API to build a knowledge graph, extracting entities and relationships.
                </div>
              </div>
...
const loadProject = async () => {
  try {
    ...
    if (response.success) {
      ...
      // Load an already-completed graph
  ...
  try {
    ...
    if (projectResponse.success && projectResponse.data.graph_id) {
      ...
      if (graphResponse.success && graphResponse.data) {
        ...
        // Re-render only when data has changed
...
const renderGraph = () => {
  ...
  // Draw edges (includes a wide transparent click area)
  ...
  simulation.on('tick', () => {
    // Update positions for all edge lines (visible and transparent click area)
