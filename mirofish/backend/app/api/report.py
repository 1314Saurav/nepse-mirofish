    ...
    try:
        ...
        def run_generate():
            try:
                ...
                # Write a visible error entry to the agent log so the frontend
                # can display it instead of spinning forever.
                try:
                    ReportManager._ensure_report_folder(report_id)
                    error_log = ReportLogger(report_id)
                    error_log.log(
                        action="report_error",
                        stage="failed",
                        details={
                            "message": f"Report generation failed: {err_msg}",
                            "error": err_msg,
